    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p>
                    Escriba el ID del mantenimiento que desea borrar:
                </p>

                <div class="page-header">
                 
                   <form action="mantenimientoEliminacion"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
