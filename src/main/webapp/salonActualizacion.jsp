    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p>
                    Introduzca los datos del Salon que desea actualizar.
                </p>

                <div class="page-header">
                    
                   <form action="salonActualizador"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
