    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-desktop"></i> Administración de Mantenimientos en la plataforma
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <p>
                    Decida que tipo de acción tomar respecto a los Mantenimientos hechos.
                </p>

                <div class="page-header">
                    
                   <a href="mantenimientoRegistro.jsp" class="btn btn-primary btn-lg">Registro</a>
                       <a href="mantenimientoBorrado.jsp" class="btn btn-primary btn-lg">Eliminación</a>
                           <a href="mantenimientoActualizacion.jsp" class="btn btn-primary btn-lg">Actualizacion</a>
