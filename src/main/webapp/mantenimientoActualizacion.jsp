    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p>
                    Introduzca los datos del Mantenimiento que desea actualizar.
                </p>

                <div class="page-header">
                    
                   <form action="mantenimientoActualizador"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fabricanteMantenimiento">
                                <p class="help-block">Ej: Cisco</p>
                            </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tipoMantenimiento">
                                <p class="help-block">Ej: 1, 2, o 3</p>
                            </div>
                       
                            <div class="form-group">
                                <label><h3> Entidad a cargo de realizar el mantenimiento:</h3>
                                </label>
                                <input type="text" class="form-control" name="entidadMantenimiento">
                                <p class="help-block">Ej: CompuTrabajo</p>
                            </div>
                           
                            <div class="form-group">
                                <label><h3> Nombre del tecnico a cargo:</h3>
                                </label>
                                <input type="text" class="form-control" name="tecnicoMantenimiento">
