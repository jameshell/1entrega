                ...
                <div class="page-header">
                   ...
                   <form action="personaControlador"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
                            ...
                            <div class="form-group">
                                <label><h3>ID transaccion</h3>
                                </label>
                                <input type="text" class="form-control" name="idTransaccion">
                                <p class="help-block">Ej: 1056373.</p>
                            </div>
                            <div class="form-group">
                                <label><h3> ID Prestamo</h3>
                                </label>
                                <input type="text" class="form-control" name="idPrestamo">
                                <p class="help-block">Ej: 9454464</p>
                            </div>
                          <div class="form-group">
                                <label><h3> idHerramienta</h3>
                                </label>
                                <input type="text" class="form-control" name="idHerramienta">
                                <p class="help-block">Ej: 5445</p>
                            </div>
